...
export function GoogleButton() {
  ...
  return (
    <button
      ...
      className="flex h-12 w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-background text-[15px] font-medium transition-colors hover:bg-surface disabled:opacity-60"
    >
