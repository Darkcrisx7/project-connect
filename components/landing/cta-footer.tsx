    ...
    <footer className="border-t border-border pb-24 pt-12 md:pb-12">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-wrap items-start justify-between gap-8">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-8 text-[13px] sm:grid-cols-4">
            <div>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-ink-muted">
                ...
                <li><a href="/terms" className="hover:text-ink">Terms &amp; Conditions</a></li>
                <li><a href="/refund-policy" className="hover:text-ink">Refunds &amp; Cancellations</a></li>
              </ul>
            </div>
          </div>
        </div>
